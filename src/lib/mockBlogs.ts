...
export const MOCK_BLOGS: BlogPost[] = [
  {
    ...
    readTime: "8 min read",
    slug: "why-westlands-best-place-invest-nairobi",
    keywords: "Westlands investment, invest in Nairobi, Westlands real estate, Nairobi ROI",
    content: `
  ...
  },
  {
    ...
    slug: "nairobi-next-investment-hub-east-africa",
    keywords: "Nairobi real estate, investment East Africa, Kenya property growth, African real estate hub",
    content: `
  ...
  },
  {
    ...
    readTime: "5 min read",
    slug: "future-luxury-real-estate-nairobi",
    keywords: "luxury real estate Nairobi, high end homes Kenya, Karen property, Muthaiga real estate",
    content: `
  ...
  },
  {
    ...
    author: "Bold Realty Team",
    readTime: "4 min read",
    slug: "minimalist-interiors-guide-2025",
    keywords: "minimalist interior, home decor 2025, luxury minimalist design, interior styling Kenya",
    content: `
  ...
  },
  {
    ...
    author: "Bold Realty Team",
    readTime: "6 min read",
    slug: "why-kilimani-hotspot-investors",
    keywords: "Kilimani real estate, Kilimani apartments, rental yield Kilimani, Nairobi buy-to-let",
    content: `
